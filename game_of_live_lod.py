...
class golBoard(object):
	...
	def liveOrDie(self,r,c):
		...
		if (r == 0 or r == self.height-1 )and (c == 0 or c == self.width-1) :
			if r== 0 and c == 0 :
				neighbors.append(self.currentGen[r][self.width-1])		  # upper middle
				neighbors.append(self.currentGen[self.height-1][self.width-1])		# upper left
				neighbors.append(self.currentGen[r+1][self.width-1])	  # upper right
				neighbors.append(self.currentGen[self.height-1][c])		   # left
				neighbors.append(self.currentGen[self.height-1][c+1])	   # bottom left
				...
				neighbors.append(self.currentGen[0][c])		   # right
				neighbors.append(self.currentGen[0][self.width-1])		# upper right
				neighbors.append(self.currentGen[r][self.width-1])		  # upper middle
				neighbors.append(self.currentGen[r-1][self.width-1])	  # upper left
				neighbors.append(self.currentGen[0][c+1])	   # bottom right
				...
				neighbors.append(self.currentGen[0][c])		   # right
				neighbors.append(self.currentGen[r][0])		   # bottom middle
				neighbors.append(self.currentGen[0][0])		 # bottom right
				neighbors.append(self.currentGen[r-1][0])	   # bottom left
				neighbors.append(self.currentGen[0][c-1])	   # upper right
				...
				neighbors.append(self.currentGen[self.height-1][c-1])		 # upper left
				neighbors.append(self.currentGen[r][c-1])		 # upper middle
				neighbors.append(self.currentGen[r+1][c-1])		 # upper right
				neighbors.append(self.currentGen[self.height-1][self.width-1])		  # left
				neighbors.append(self.currentGen[self.height-1][0])				 # bottom left
				neighbors.append(self.currentGen[r+1][c])		 # right
				neighbors.append(self.currentGen[r][0])				# bottom middle
				neighbors.append(self.currentGen[r+1][0])			 # bottom right
			elif r == 0:
				neighbors.append(self.currentGen[self.height-1][c-1])	   # upper left
				neighbors.append(self.currentGen[self.height-1][c])		   # left
				neighbors.append(self.currentGen[r+1][c])		 # right
